...
const ALLOWED_ORIGINS = (process.env.ALLOWED_ORIGINS || 'https://sanctuary-app.example.com,http://localhost:3000,http://localhost:5173').split(',').map(v => v.trim()).filter(Boolean);
